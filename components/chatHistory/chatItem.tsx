...
export const ChatItem: React.FC<ChatItemProps> = ({
  ...
  return (
    <li key={chat._id} className="flex justify-between">
      <div className="flex justify-between text-sm text-slate-700 rounded-lg w-full hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
        {editingChatId === chat._id && renameChat ? (
          ...
          <Link
            className="flex items-center text-ellipsis gap-x-3 py-2  px-2 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
