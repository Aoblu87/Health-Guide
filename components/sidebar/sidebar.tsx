    ...
    return (
        <>
            <div className="col-start-3 relative " >
                <div className="hs-tooltip inline-block [--placement:right] absolute" style={{top:300 }}>
                    <button
                        type="button"
                        className="hs-tooltip-toggle w-10 h-10 inline-flex justify-center items-center gap-2 text-gray-600 dark:text-gray-400 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white"                        data-hs-overlay="#docs-sidebar"
