...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row text-deep-teal-900 justify-center items-center mt-5 mb-3">
        <p className="flex text-sm justify-center lg:me-3">AI can make mistakes.</p>
        <br className="md:hidden" />{" "}
        <span className="text-sm">Consider checking important information.</span>
      </div>
